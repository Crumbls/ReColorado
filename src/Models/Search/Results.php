<?php namespace Crumbls\ReColorado\Models\Search;
...
class Results implements Countable, ArrayAccess, IteratorAggregate
{
    protected $resource;
    protected $class;
    /** @var \Crumbls\ReColorado\Session */
    protected $session;
    protected $metadata = null;
    protected $total_results_count = 0;
    protected $returned_results_count = 0;
    protected $error = null;
    /** @var \Illuminate\Support\Collection|\Crumbls\ReColorado\Models\Search\Record[] */
    protected $results;
    protected $headers = [];
     ...
     * @param null $keyed_by
     */
    public function addRecord(\Illuminate\Database\Eloquent\Model $record, $keyed_by = null)
    {
        /**
         * By here, or earlier, cast it to a model, not the trash way we are doing it now.
         * If we could automatically cast this to a user, property, etc, we'd be much happier
         * with how this turns out.  It will save us a ton of work down the road too.
         * It will save us a ton of time to just do it now.
         *
         * I need to spend at least an hour or two thinking about how to do this better.
         */

        // register this Results object as the record's parent automatically
        if (method_exists($record, 'setParent')) {
    ...
    /**
     * @return \Crumbls\ReColorado\Session
     */
    ...
    /**
     * @param \Crumbls\ReColorado\Session $session
     * @return $this
     */
