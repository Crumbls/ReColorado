...
use Crumbls\ReColorado\Exceptions\InvalidConfiguration;
use Crumbls\ReColorado\Strategies\StandardStrategy;
use Crumbls\ReColorado\Strategies\Strategy;
use Crumbls\ReColorado\Versions\RETSVersion;
...
class Configuration
{
    ...
    protected $password;
    protected $login_url;
    protected $user_agent = 'Crumbls\ReColorado/2.6.2';
    protected $user_agent_password;
    /** @var RETSVersion */
    protected $rets_version;
    protected $http_authentication = 'digest';
    /** @var \Crumbls\ReColorado\Strategies\Strategy */
    protected $strategy;
    protected $options = [];
