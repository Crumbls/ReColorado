<?php namespace Crumbls\ReColorado;
...
use Crumbls\ReColorado\Exceptions\CapabilityUnavailable;
use Crumbls\ReColorado\Exceptions\MetadataNotFound;
use Crumbls\ReColorado\Exceptions\MissingConfiguration;
use Crumbls\ReColorado\Exceptions\RETSException;
use Crumbls\ReColorado\Http\Client as RetClient;
use Crumbls\ReColorado\Interpreters\GetObject;
use Crumbls\ReColorado\Interpreters\Search;
use Crumbls\ReColorado\Models\BaseObject;
use Crumbls\ReColorado\Models\Bulletin;
...
class Session
{
    ...
    public function __construct(Configuration $configuration)
    {
        ...
        $this->client = RetClient::make($defaults);
    ...
    {
        if (!$this->configuration or !$this->configuration->valid()) {
            throw new MissingConfiguration("Cannot issue Logout without a valid configuration loaded");
        }
     ...
     * @param $content_id
     * @param int $location
     * @return \Crumbls\ReColorado\Models\BaseObject
     */
     ...
     * @return Collection|\Crumbls\ReColorado\Models\Metadata\Resource
     */
    public function GetResourcesMetadata($resource_id = null)
    {
        ...
        if ($resource_id) {
            foreach ($result as $r) {
                /** @var \Crumbls\ReColorado\Models\Metadata\Resource $r */
     ...
     * @return \Illuminate\Support\Collection|\Crumbls\ReColorado\Models\Metadata\Table[]
     * @throws Exceptions\CapabilityUnavailable
     */
     ...
     * @return \Crumbls\ReColorado\Models\Search\Results
     * @throws Exceptions\CapabilityUnavailable
     */
    ...
    protected function request($capability, $options = [], $is_retry = false)
    {
        ...
        $response = new \Crumbls\ReColorado\Http\Response($response);
    ...
    public function getDefaultOptions()
    {
        $defaults = [
            ...
            'curl' => [ CURLOPT_COOKIEFILE => tempnam('/tmp', 'Crumbls\ReColorado') ]
        ];
