<?php namespace Crumbls\ReColorado\Parsers\GetObject;

use GuzzleHttp\Psr7\Response;
use Crumbls\ReColorado\Http\Response as Crumbls\ReColoradoResponse;
use Illuminate\Support\Collection;

class Multiple
{
    public function parse(Crumbls\ReColoradoResponse $response)
    {
        ...
        foreach ($multi_parts as $part) {
            ...
            $single = new Crumbls\ReColoradoResponse(new Response($parts->getStatusCode(), $parts->getHeaders(), (string)$parts->getBody()));
